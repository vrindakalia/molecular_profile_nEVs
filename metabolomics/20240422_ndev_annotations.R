...
data_lib %>% write_tsv("results/NDEV/level1-5_c18_neg_features_NDEV.txt")
...
data_lib %>% write_tsv("results/NDEV/level1-5_c18_pos_features_NDEV.txt")
...
# Call in the feature list of interest
ndev_hilicpos <- read_tsv("results/NDEV/hilic_pos_serum_features_NDEV.txt")
...
data_lib %>% write_tsv("results/NDEV/level1-5_hilic_pos_features_NDEV.txt")
...
# Call in the feature list of interest
ndev_hilicneg <- read_tsv("results/NDEV/hilic_neg_serum_features_NDEV.txt")
...
data_lib %>% write_tsv("results/NDEV/level1-5_hilic_neg_features_NDEV.txt")
